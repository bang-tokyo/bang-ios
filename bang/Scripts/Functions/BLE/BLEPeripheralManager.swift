...
extension BLEPeripheralManager: CBPeripheralManagerDelegate {
        ...
        didReceiveReadRequest request: CBATTRequest)
    {
        ...
        locationManager.startLocationUpdates({
            ...
            request.value = try? NSJSONSerialization.dataWithJSONObject(_responseDictonary, options: NSJSONWritingOptions.PrettyPrinted)
    ...
    func peripheralManagerDidUpdateState(peripheral: CBPeripheralManager) {
        ...
        let service = CBMutableService(type:kBLEServiceUUID, primary:true)
